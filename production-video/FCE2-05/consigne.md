# Consigne de génération — FCE2-05
...
Objectif unique : faire retenir que beaucoup de mots sont fabriqués avec des morceaux, et les morceaux se reconnaissent d'un mot à l'autre.
...
5. l'outil « Les briques », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FCE2-05 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FCE2-05.json`. NotebookLM fournit le
