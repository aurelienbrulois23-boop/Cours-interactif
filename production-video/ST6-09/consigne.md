...
Objectif unique : faire retenir que un programme fait exactement ce qui est écrit, jamais ce qu'on voulait — et qu'un bogue se cherche dans les instructions, pas dans l'intention.
...
5. l'outil « Le somnambule », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module ST6-09 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/ST6-09.json`. NotebookLM fournit le
