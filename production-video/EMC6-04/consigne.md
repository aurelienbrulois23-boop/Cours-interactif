# Consigne de génération — EMC6-04
...
Objectif unique : faire retenir que le principe de laïcité ne s'applique pas partout de la même façon : le programme distingue la sphère publique, l'espace public et la sphère privée, et fait de l'école un lieu particulier.
...
5. l'outil « Le seuil », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module EMC6-04 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/EMC6-04.json`. NotebookLM fournit le
