...
Objectif unique : faire retenir que ce qu'on sait des débuts de l'humanité vient de traces inégalement conservées — et que l'absence d'une trace ne prouve jamais l'absence de la pratique.
...
5. l'outil « Le tamis », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module H6-01 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/H6-01.json`. NotebookLM fournit le
