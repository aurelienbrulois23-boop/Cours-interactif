# Consigne de génération — FCE2-02
...
Objectif unique : faire retenir que certaines lettres s'écrivent sans se dire — et elles ne sont pas là pour rien.
...
5. l'outil « La loupe », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FCE2-02 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FCE2-02.json`. NotebookLM fournit le
