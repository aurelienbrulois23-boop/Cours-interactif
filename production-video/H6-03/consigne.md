...
Objectif unique : faire retenir que l'écriture apparaît là où un pouvoir a besoin d'enregistrer — et qu'une écriture de comptes renseigne surtout sur ce que ses producteurs ont choisi de compter.
...
5. l'outil « Le tampon », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module H6-03 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/H6-03.json`. NotebookLM fournit le
