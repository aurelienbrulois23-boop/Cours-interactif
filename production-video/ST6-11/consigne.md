...
Objectif unique : faire retenir que les êtres vivants d'un écosystème dépendent les uns des autres par bien plus qu'une chaîne : chacun tient plusieurs fils à la fois.
...
5. l'outil « Le nœud », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module ST6-11 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/ST6-11.json`. NotebookLM fournit le
