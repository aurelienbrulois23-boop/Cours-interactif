...
Objectif unique : faire retenir que un signal — lumineux, sonore ou électrique — transporte une information sans la contenir : c'est un accord préalable qui lui donne son sens.
...
5. l'outil « Le messager », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module ST6-04 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/ST6-04.json`. NotebookLM fournit le
