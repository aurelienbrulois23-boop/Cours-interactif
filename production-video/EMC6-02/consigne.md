# Consigne de génération — EMC6-02
...
Objectif unique : faire retenir que l'intérêt général est l'intérêt commun à tous — il n'est ni la somme des intérêts particuliers, ni l'avis de la majorité, et il peut s'opposer au mien.
...
5. l'outil « Le pot commun », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module EMC6-02 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/EMC6-02.json`. NotebookLM fournit le
