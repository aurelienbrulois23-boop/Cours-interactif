...
Objectif unique : faire retenir que les relations entre l'Empire romain et la Chine des Han passent par des réseaux et des intermédiaires — et qu'une ligne tracée sur une carte efface précisément ce qui compte.
...
5. l'outil « Le trait de crayon », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module H6-09 — donc **après le verdict**.
