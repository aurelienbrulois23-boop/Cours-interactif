...
Objectif unique : faire retenir que un texte se fabrique en plusieurs passages : le premier jet n'est pas un brouillon raté, c'est de la matière.
...
5. l'outil « Le brouillon », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FR6-07 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FR6-07.json`. NotebookLM fournit le
