...
Objectif unique : faire retenir que un récit d'aventure ramène souvent au point de départ — le lieu est le même, celui qui revient ne l'est plus.
...
5. l'outil « La boucle », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FR6-05 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FR6-05.json`. NotebookLM fournit le
