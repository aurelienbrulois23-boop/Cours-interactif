# Consigne de génération — EMC6-06
...
Objectif unique : faire retenir que le droit à l'oubli existe, et le faire valoir est difficile : avoir un droit et pouvoir l'exercer sont deux choses.
...
5. l'outil « L'empreinte », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module EMC6-06 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/EMC6-06.json`. NotebookLM fournit le
