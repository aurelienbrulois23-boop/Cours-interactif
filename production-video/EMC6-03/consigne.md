# Consigne de génération — EMC6-03
...
Objectif unique : faire retenir que la laïcité est un principe juridique, pas une opinion : elle garantit la liberté de croire, de ne pas croire et de changer.
...
5. l'outil « Le cadre », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module EMC6-03 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/EMC6-03.json`. NotebookLM fournit le
