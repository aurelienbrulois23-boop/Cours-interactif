# Consigne de génération — EMC6-05
...
Objectif unique : faire retenir que le droit au respect de la vie privée s'appuie sur d'autres droits — celui à la vie, au nom, à la nationalité — et il comprend le droit à l'intimité et à l'image.
...
5. l'outil « L'étai », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module EMC6-05 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/EMC6-05.json`. NotebookLM fournit le
