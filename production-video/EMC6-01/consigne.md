# Consigne de génération — EMC6-01
...
Objectif unique : faire retenir que un représentant porte la parole des autres et prend part à une délibération — il ne décide pas seul, et il ne parle pas en son nom.
...
5. l'outil « Le porte-voix », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module EMC6-01 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/EMC6-01.json`. NotebookLM fournit le
