...
Objectif unique : faire retenir que une métropole se reconnaît à ses fonctions et à ses flux, pas à sa taille — et elle n'est pas la même ville selon qui la pratique.
...
5. l'outil « Les calques », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module G6-01 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/G6-01.json`. NotebookLM fournit le
