...
Objectif unique : faire retenir que dissoudre n'est pas faire disparaître : la masse se conserve alors que l'aspect change, et un mélange n'est pas toujours ce qu'il paraît.
...
5. l'outil « Le bocal », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module ST6-01 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/ST6-01.json`. NotebookLM fournit le
