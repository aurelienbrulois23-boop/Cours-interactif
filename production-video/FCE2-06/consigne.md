# Consigne de génération — FCE2-06
...
Objectif unique : faire retenir que un même mot peut faire deux métiers différents : celui de tous les jours, et un autre, emprunté.
...
5. l'outil « Le déguisement », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FCE2-06 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FCE2-06.json`. NotebookLM fournit le
