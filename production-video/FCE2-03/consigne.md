# Consigne de génération — FCE2-03
...
Objectif unique : faire retenir que un petit mot comme il remplace quelqu'un — et il faut savoir qui, sinon on lit une autre histoire.
...
5. l'outil « La ficelle », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FCE2-03 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FCE2-03.json`. NotebookLM fournit le
