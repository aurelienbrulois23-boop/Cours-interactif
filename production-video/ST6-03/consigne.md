...
Objectif unique : faire retenir que l'énergie ne se crée pas : elle se convertit et se transfère — et qu'une « source » d'énergie est toujours quelque chose qu'on prélève ailleurs.
...
5. l'outil « Le relais », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module ST6-03 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/ST6-03.json`. NotebookLM fournit le
