# Consigne de génération — FCE2-04
...
Objectif unique : faire retenir que on peut savoir une chose qui n'est pas écrite — à condition de s'appuyer sur le texte ET sur ce qu'on sait.
...
5. l'outil « Le pont », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FCE2-04 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FCE2-04.json`. NotebookLM fournit le
