...
Objectif unique : faire retenir que une phrase complexe contient plusieurs propositions, et l'on compte les propositions en comptant les verbes conjugués.
...
5. l'outil « La poupée gigogne », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FR6-08 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FR6-08.json`. NotebookLM fournit le
