...
Objectif unique : faire retenir que un objet technique répond à un besoin par des fonctions techniques — et que décrire un objet, c'est retrouver la demande à laquelle il répondait.
...
5. l'outil « La commande », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module ST6-08 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/ST6-08.json`. NotebookLM fournit le
