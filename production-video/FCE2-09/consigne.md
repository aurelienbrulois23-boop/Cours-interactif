# Consigne de génération — FCE2-09
...
Objectif unique : faire retenir que on ne relit pas tout en même temps : on repasse plusieurs fois, en cherchant une seule chose à chaque passage.
...
5. l'outil « Le peigne », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FCE2-09 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FCE2-09.json`. NotebookLM fournit le
