...
Objectif unique : faire retenir que un littoral est une bande étroite que des usages incompatibles se disputent — et c'est là qu'on aménage le plus, à l'endroit le plus exposé.
...
5. l'outil « L'étagère », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module G6-05 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/G6-05.json`. NotebookLM fournit le
