...
Objectif unique : faire retenir que le statut des chrétiens dans l'Empire change par décisions et varie selon les lieux — et qu'une frise de décisions ne décrit pas ce que vivent les gens.
...
5. l'outil « La balance », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module H6-08 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/H6-08.json`. NotebookLM fournit le
