...
Objectif unique : faire retenir que au théâtre, le spectateur sait souvent ce qu'un personnage ignore — et c'est cet écart qui fait la ruse, le rire et l'inquiétude.
...
5. l'outil « Le double fond », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FR6-04 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FR6-04.json`. NotebookLM fournit le
