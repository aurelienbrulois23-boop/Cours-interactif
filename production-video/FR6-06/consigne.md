...
Objectif unique : faire retenir que un monstre de récit a une part d'humanité, et il dit surtout ce que craint la société qui l'imagine.
...
5. l'outil « Le miroir », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FR6-06 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FR6-06.json`. NotebookLM fournit le
