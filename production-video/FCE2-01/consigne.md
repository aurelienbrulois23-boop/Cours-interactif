# Consigne de génération — FCE2-01
...
Objectif unique : faire retenir que avant de dire ce qu'un texte raconte, on retourne au texte et on montre la ligne.
...
5. l'outil « Le doigt », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FCE2-01 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FCE2-01.json`. NotebookLM fournit le
