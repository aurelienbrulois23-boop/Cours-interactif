...
Objectif unique : faire retenir que la Terre est une planète active, et qu'une tendance climatique ne se lit pas sur un jour ni sur une saison mais sur une longue série de mesures.
...
5. l'outil « La fenêtre », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module ST6-10 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/ST6-10.json`. NotebookLM fournit le
