...
Objectif unique : faire retenir que une plante fixée se reproduit en faisant porter son pollen par d'autres — et que la pollinisation s'établit par des observations et des données, non par une histoire plaisante.
...
5. l'outil « Le facteur », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module ST6-07 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/ST6-07.json`. NotebookLM fournit le
