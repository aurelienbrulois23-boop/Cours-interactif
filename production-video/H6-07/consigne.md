...
Objectif unique : faire retenir que la romanisation désigne des transformations inégales et négociées — et qu'un monument renseigne d'abord sur ceux qui l'ont voulu, pas sur ceux qui vivaient autour.
...
5. l'outil « La vitrine », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module H6-07 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/H6-07.json`. NotebookLM fournit le
