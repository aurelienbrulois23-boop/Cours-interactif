# Consigne de génération — FCE2-10
...
Objectif unique : faire retenir que participer à un échange, ce n'est pas placer sa phrase : c'est tenir compte de ce qui vient d'être dit.
...
5. l'outil « Le rebond », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FCE2-10 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FCE2-10.json`. NotebookLM fournit le
