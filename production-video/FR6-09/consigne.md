...
Objectif unique : faire retenir que le verbe s'accorde avec son sujet, même quand des mots se sont glissés entre les deux.
...
5. l'outil « Le fil », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FR6-09 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FR6-09.json`. NotebookLM fournit le
