...
Objectif unique : faire retenir que un texte religieux s'étudie comme une source sur des croyances et une transmission — et qu'un manuscrit prouve la transmission du texte, jamais les événements qu'il raconte.
...
5. l'outil « La photocopieuse », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module H6-06 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/H6-06.json`. NotebookLM fournit le
