...
Objectif unique : faire retenir que produire sa nourriture transforme profondément des sociétés, mais pas partout au même rythme ni de la même façon — et que le mot « révolution » dit bien l'ampleur en trompant sur la durée.
...
5. l'outil « Le sablier », énoncé exactement comme dans la source ;
...
- ne pas transformer le statut « rapporté » en certitude ;
...
Emplacement `medias.transformation` du module H6-02 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/H6-02.json`. NotebookLM fournit le
