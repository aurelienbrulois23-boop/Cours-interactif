...
Objectif unique : faire retenir que toute carte du monde a choisi ce qu'elle déforme : on ne met pas une sphère à plat sans déchirer ou étirer.
...
5. l'outil « La peau d'orange », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module G6-06 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/G6-06.json`. NotebookLM fournit le
