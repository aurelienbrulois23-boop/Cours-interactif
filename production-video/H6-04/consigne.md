...
Objectif unique : faire retenir que le mot démocratie, à Athènes, désigne une participation politique réelle mais réservée aux citoyens.
...
5. l'outil « Le guichet », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module H6-04 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/H6-04.json`. NotebookLM fournit le
