...
Objectif unique : faire retenir que une contrainte n'existe que par rapport à un projet : changez le projet, la contrainte se déplace.
...
5. l'outil « Le gabarit », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module G6-03 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/G6-03.json`. NotebookLM fournit le
