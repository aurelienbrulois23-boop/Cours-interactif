...
Objectif unique : faire retenir que un mouvement ne se décrit jamais sans dire par rapport à quoi — et qu'une vitesse se calcule à partir d'une distance et d'une durée.
...
5. l'outil « Le repère », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module ST6-02 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/ST6-02.json`. NotebookLM fournit le
