# Consigne de génération — FCE2-08
...
Objectif unique : faire retenir que quand un nom est au pluriel, les mots autour de lui le répètent par écrit, même quand on n'entend rien.
...
5. l'outil « L'écho », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FCE2-08 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FCE2-08.json`. NotebookLM fournit le
