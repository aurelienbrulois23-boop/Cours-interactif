...
Objectif unique : faire retenir que un récit de fondation renseigne d'abord sur ceux qui le racontent.
...
5. l'outil « Le train », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module H6-05 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/H6-05.json`. NotebookLM fournit le
