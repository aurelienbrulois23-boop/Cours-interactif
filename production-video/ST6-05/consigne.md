...
Objectif unique : faire retenir que on classe les êtres vivants d'après ce qu'ils possèdent en commun, jamais d'après ce qui leur manque ni d'après leur ressemblance apparente.
...
5. l'outil « La clé », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module ST6-05 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/ST6-05.json`. NotebookLM fournit le
