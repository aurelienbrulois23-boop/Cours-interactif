...
Objectif unique : faire retenir que là où le milieu est le même, on trouve des façons d'habiter différentes : le milieu limite les possibles, il n'en choisit aucun.
...
5. l'outil « La fourche », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module G6-07 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/G6-07.json`. NotebookLM fournit le
