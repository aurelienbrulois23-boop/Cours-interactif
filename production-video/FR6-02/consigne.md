...
Objectif unique : faire retenir que les récits des origines existent en plusieurs versions, venues de traditions différentes — et les comparer n'est pas les départager.
...
5. l'outil « La version », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FR6-02 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FR6-02.json`. NotebookLM fournit le
