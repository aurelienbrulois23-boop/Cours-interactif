...
Objectif unique : faire retenir que la force d'un poème tient à ses images et à son pouvoir d'évocation, au-delà des vers et des rimes.
...
5. l'outil « Le levier », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FR6-03 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FR6-03.json`. NotebookLM fournit le
