...
Objectif unique : faire retenir que un récit ne montre pas tout : il éclaire une part de la scène et laisse le reste dans le noir — et ce noir est un choix.
...
5. l'outil « La lampe », énoncé exactement comme dans la source ;
...
Emplacement `medias.transformation` du module FR6-01 — donc **après le verdict**.
...
renseigner à la main dans `site/modules/FR6-01.json`. NotebookLM fournit le
